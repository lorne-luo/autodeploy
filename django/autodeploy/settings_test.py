...
DJANGO_ROOT_URL = 'http://127.0.0.1:7000'

# django deployed for which environment
# only two option: ENVIRONMENT_PRODUCTION,ENVIRONMENT_DEVELOPMENT
DEFAULT_ENVIRONMENT = ENVIRONMENT_TESTING
...
if DEFAULT_ENVIRONMENT == ENVIRONMENT_PRODUCTION or DEFAULT_ENVIRONMENT == ENVIRONMENT_STAGING:
    ...
    ENVIRONMENT_CHOICES = ((ENVIRONMENT_DEVELOPMENT, ENVIRONMENT_DEVELOPMENT),(ENVIRONMENT_TESTING, ENVIRONMENT_TESTING),)
